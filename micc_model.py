# micc_train_code/micc_model.py
# ------------------------------------------------------------
# MICCAI-prep FAC-Net voxel-wise model (concept-locked)
#
# Concept (fixed):
...
#   - Output: 9 params (B,9,1,1) for existing FACNetLoss physics supervision
#
# Forward signature:
